...
public class PreviewData extends SettingsPreferenceFragment
    ...
    private static final String KVERSION = "preview_kversion";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mKVersion = (Preference) prefSet.findPreference(KVERSION);
            ...
            mKVersion.setSummary(Utilities.getKernelVersion());
