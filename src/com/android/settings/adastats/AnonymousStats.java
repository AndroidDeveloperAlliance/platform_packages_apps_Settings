...
public class AnonymousStats extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            ...
            mPrefs = getActivity().getSharedPreferences("ADAStats", 0);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mEnableReporting) {
            ...
            Uri uri = Uri.parse("http://stats.androiddeveloperalliance.org");
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            Uri uri = Uri.parse("http://www.androiddeveloperalliance.org/blog/adastats-what-it-is-and-why-you-should-opt-in");
            startActivity(new Intent(Intent.ACTION_VIEW, uri));
        }
    }
