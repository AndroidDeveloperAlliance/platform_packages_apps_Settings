...
public class ReportingService extends Service {
    protected static final String TAG = "ADAStats";
    ...
    private void report() {
        ...
        HttpPost httppost = new HttpPost("http://stats.androiddeveloperalliance.org/submit");
        try {
            ...
            getSharedPreferences("ADAStats", 0).edit().putLong(AnonymousStats.ANONYMOUS_LAST_CHECKED,
